...
function Hero() {
  return (
    <div className="container">
      <div className="row">
        <h1 className="fs-3 text-center text-muted pt-5 mb-5 mt-5 ">
          We pioneered the discount broking model in India.
          <br />
          Now, we are breaking ground with our technology.
        </h1>
      </div>
      <div className="row border-top p-5 mt-5" style={{lineHeight:"1.8",fontSize:"1.1em"}}>
        <div className="col ms-5 me-2">
          <p>
